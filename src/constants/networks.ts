...
export const NETWORKS_AVAILABLE_LIMIT: ChainId[] = [OP_CHAIN_ID, ARBITRUM_CHAIN_ID, BASE_CHAIN_ID, GNOSIS_CHAIN_ID, SCROLL_CHAIN_ID];
...
export const NETWORK_URLS: { [chainId: ChainId]: string } = {
  [MAINNET_CHAIN_ID]: 'https://eth-mainnet.g.alchemy.com/v2/LnOWF7MPoOba1gqE1VVE4HwfzV3sZ7C1',
  [SEPOLIA_CHAIN_ID]: 'wss://eth-mainnet.g.alchemy.com/v2/k4-7Agacy4KzCQ7xPvGGVVoMxsnB_sYy',
  [KOVAN_CHAIN_ID]: 'https://eth-kovan.alchemyapi.io/v2/kKt4rItTbSfgSw5yTtZlRmqwQXU890aF',
  [BSC_CHAIN_ID]: 'https://bnb.sakurarpc.io',
  [POLYGON_CHAIN_ID]: 'https://polygon-mainnet.g.alchemy.com/v2/vgWq-MQPsICWFFAU1TYOZ3dpGXhYfpg8',
  ...
  [OP_CHAIN_ID]: 'https://sly-virulent-waterfall.optimism.quiknode.pro/e7187027dce1e6ffb4eef92ac5066a0b94ea28ef/',
  ...
  [BASE_CHAIN_ID]: 'https://thrumming-fabled-card.base-mainnet.quiknode.pro/1c955f4a7b1fc1789d1469edc2f0ea074cec09ac/',
